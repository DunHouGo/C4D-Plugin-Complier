...
Usage:
  vpr task:complete TASK_NAME       Complete a task
  vpr task:rename-done              Rename all existing completed tasks

Examples:
  vpr task:complete frontend-performance
  vpr task:complete 2
  vpr task:rename-done
