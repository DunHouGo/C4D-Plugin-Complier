...
export function AppearancePane() {
  ...
  const handleLanguageChange = async (value: string) => {
    ...
    try {
      ...
      if (language) {
        ...
        const targetLang =
          getBestAvailableLanguage(systemLocale) ?? defaultLanguage
  ...
  const currentLanguageValue = preferences?.language
    ? (getBestAvailableLanguage(preferences.language) ?? 'system')
    : 'system'
